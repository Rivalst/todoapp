...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Color _greyColor = Color(0xFFF0F0F7);
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Spacer(),
            if(mark)
              Icon(Icons.circle, size: 15.0, color: Color(0xFF4AD991)),
            if (notifi)
              Padding(
                  padding: const EdgeInsets.all(16.0),
    ...
    return Padding(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Color(0xFFFFCA83).withOpacity(0.3), width: 1.0),
          boxShadow: [
            BoxShadow(
